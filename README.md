...
pip install --no-build-isolation -e .#这里需要用cuda12.8不能用13.1
cd ..
...
python FP-Quant/model_quant.py \
  --model_name_or_path /mnt/model/Meta-Llama-3-8B \
...
--model /mnt/model/Meta-Llama-3-8B \
--kernel-1 pseudo \
--kernel-2 real
...
| ------ | ------ | ------------- | -------- | ------ | --------- |
| 5090   | real   | 0.4249        | 0.7454   | 0.7667 | 0.5588    |
| 5090   | pseudo | 0.4138        | 0.7420   | 0.7810 | 0.5624    |

ARCquant(llama3-8b)

| device | Kernel | arc_challenge | arc_easy | boolq | hellaswag |
| :----- | :----- | :-----------: | :------: | :---: | :-------: |
| 5090   | real   |     48.04     |  79.42  | 79.97 |   58.57   |
| 5090   | pseudo |     48.04     |  76.52  | 78.29 |   58.85   |
| A100   | pseudo |     47.35     |  78.41  | 78.86 |   58.51   |


### emu_sys(llama3-8b)

| device | Kernel | arc_challenge | arc_easy | boolq | hellaswag | mmlu  |
| ------ | ------ | :-----------: | :------: | :---: | :-------: | ----- |
| 5090   | real   |     46.08     |  75.67  | 78.53 |   58.92   | 58.08 |
| 5090   | pseudo |     46.25     |  75.50  | 78.26 |   58.86   | 58.23 |
